...
class OrderFulfillmentPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissionData = [
            ...
            ['name' => 'adminOrderList', 'category_id' =>16, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'),'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
            ...
            ['name' => 'installationTasks', 'category_id' =>23, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'),'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
